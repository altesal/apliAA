# Agent Instructions for Calendar Project
...
This is a calendar application built with modern web technologies. The application allows users to:

- Create shortened URLs
- Manage application  with authentication
